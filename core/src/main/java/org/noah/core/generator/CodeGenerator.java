...
//    private static final String MODULE = "file"; //子包名
    ...
    private static final String MODULE = "sys"; //子包名
    private static final String MODULE_PARENT = "org.noah.web"; //包名
    private static final String TABLE = "SYS_AREA"; //表名（大写）
    private static final String PREFIX = ""; //表名称前缀
    private static final String POJO_PACKAGE = "area";  //存放pojo的子包名
    private static final String PERMISSION_PREFIX = "sys-area";  //权限标识前缀
    private static final String REQUEST_MAPPING_PREFIX = "/sys/area";  //请求路径前缀
    private static final String TABLE_DESC = "区划"; //表备注
